...
I picked up option A. Normally for this term I am more similar to option B. This term  I had course that is Management Information Systems which is not a CS course. We are using MySQLWorkbench. But in my opinion option A is more pure backend in comparison to option B. Normally most of our courses consisting backend OOP and Data Structures. Previous term we had Software Engineering course but I want to play a role in Fronend team. Because I had been wondering fetches, connections, design, HTML, CSS etc these kinds of stuff in Frontend. Additionally we haven't got any Frontend Course in Sabanci. So I decided to develop frontend. But we were in communcation with Backend Team. Backend Team were exactly doing these kind of Backend tasks. Consequently I am planning move from Backend. To enforce my self I picked option A.
...
changed my compiler to VSCode and installed extensions. I installed Java Extension Pack and Spring Boot Extension Pack. Then I was ready to start. Somehow I couldn't handle to use it. Also I used Google Collab for discover the dataset. Skimmed rows and columns did some operations with the all provided dataset from Carla. Previously I had a taken course Cyber Securtiy in that course we developed a project to show vulnerabilities on a website. Our purpose was to show 5 vulnerabilites from OWASP's top 10 Vulnerability in 2023. We developed that website with Flask. Also in my internship during Vakıfbank they had been using Flask which is Python Framework. Firstly I did not want to use MongoDB and Postman because during our Mobile Application Course we had very tough situation to connect servers. Even professors couldn't find solution in some cases. But I hadn't any option in my mind to develop the project. So I started with Flask and Postman. Then I initialized my environment to use Flask. Moved to virtual environemnt and installed Flask from my terminal then activated it. Untill step2 I used salary_survey-1.csv dataset and for the step 3 I used salary_survey-1.csv and salary_survey-2.csv
